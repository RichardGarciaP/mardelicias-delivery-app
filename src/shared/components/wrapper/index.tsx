...
export default function Wrapper({children, backgroundColorStatusBar, barStyle, loading, titleLoader}: WrapperProps) {
  const {isDarkMode} = useDarkMode()
  return (
    <View style={{flex: 1, backgroundColor: isDarkMode ? semantic.background.dark.d500 : 'white'}}>
